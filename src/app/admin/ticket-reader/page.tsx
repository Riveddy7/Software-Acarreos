...
export default function AdminTicketReaderPage() {
  ...
  return (
    <div className="w-full max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md border border-gray-200 space-y-6">
      <h2 className="text-2xl font-bold text-center text-gray-800 mb-4">Lector de Tickets</h2>

      <AdminQrReader label="ID del Ticket" placeholder="Ingrese el ID del ticket" onScan={handleScan} />

      {isLoading && <p className="text-center text-lg text-gray-700 mt-4">Buscando ticket...</p>}
      ...
      {shipment && !isLoading && !error && (
        <div className="space-y-4 mt-6">
          <h3 className="text-xl font-semibold text-gray-800">Detalles del Acarreo Asociado</h3>
