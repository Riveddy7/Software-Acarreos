...
import QrCodeDisplay from '@/components/admin/QrCodeDisplay'; // Reusing QrCodeDisplay
...
export default function TicketPage() {
  ...
  const ticketType = searchParams.get('type'); // 'dispatch' or 'delivery'
  ...
  const fetchData = useCallback(async () => {
    if (!shipmentId) {
      setError('ID de acarreo no proporcionado.');
      setIsLoading(false);
      return;
    }
